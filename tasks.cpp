...
void task_6() {
    cout << "ПРИБЛИЖЕННОЕ ВЫЧИСЛЕНИЕ ИНТЕГРАЛОВ ПРИ ПОМОЩИ КВАДРАТУРНЫХ ФОРМУЛ НАИВЫСШЕЙ АЛГЕБРАИЧЕСКОЙ СТЕПЕНИ ТОЧНОСТИ" << endl
         << "13-ый вариант" << endl
         << "[a, b] = [0, 1], f(x) = sin(x), p(x) = exp^(-x)" << endl;
    double a, b, n, m;
    double epsilon = 0.000000000001;
    char key;
    cout << "Введите значение ключа:" << endl
...
void task_7() {
    cout << "РЕШЕНИЕ ЗАДАЧИ КОШИ ДЛЯ ОДУ ПЕРВОГО ПОРЯДКА" << endl
         << "13-ый вариант" << endl
         << "y'(x) = -y(x) + 2 * y(x)^2 + 1, y(0) = 0.25" << endl;
    int n;
    double h;
    char key;
    cout << "Введите значение ключа:" << endl
    ...
    while (key != 'q') {
        ...
        for (int i = -2; i <= n; i++) {
            cout << "При x = " << x_0 + i * h << endl
                 << "--------------------------------------------------------------------------------" << endl
                 << "Точное решение равно " << setprecision(12) << exact_sol(x_0 + i * h) << endl
                 << "--------------------------------------------------------------------------------" << endl
                 << "Приближенное решение методом разложения в ряд Тейлора равно " << setprecision(12) << Taylor(0, 0.25, h, i) << endl
                 << "При этом погрешность равна " << setprecision(12) << abs(Taylor(0, 0.25, h, i) - exact_sol(x_0 + i * h)) << endl;
            if (i >= 1) {
                cout << "--------------------------------------------------------------------------------" << endl
                     << "Приближенное решение методом Эйлера равно " << setprecision(12) << Euler_1(0, 0.25, h, i) << endl
                     << "При этом погрешность равна " << setprecision(12) << abs(Euler_1(0, 0.25, h, i) - exact_sol(x_0 + i * h)) << endl
                     << "--------------------------------------------------------------------------------" << endl
                     << "Приближенное решение первым модификационным методом Эйлера равно " << setprecision(12) << Euler_2(0, 0.25, h, i) << endl
                     << "При этом погрешность равна " << setprecision(12) << abs(Euler_2(0, 0.25, h, i) - exact_sol(x_0 + i * h)) << endl
                     << "--------------------------------------------------------------------------------" << endl
                     << "Приближенное решение вторым модификационным методом Эйлера равно " << setprecision(12) << Euler_3(0, 0.25, h, i) << endl
                     << "При этом погрешность равна " << setprecision(12) << abs(Euler_3(0, 0.25, h, i) - exact_sol(x_0 + i * h)) << endl
                     << "--------------------------------------------------------------------------------" << endl
                     << "Приближенное решение методом Рунге-Кутты 4-го порядка равно " << setprecision(12) << Runge(0, 0.25, h, i) << endl
                     << "При этом погрешность равна " << setprecision(12) << abs(Runge(0, 0.25, h, i) - exact_sol(x_0 + i * h)) << endl;
            }
            if (i >= 3) {
                cout << "--------------------------------------------------------------------------------" << endl
                     << "Приближенное решение методом Адамса равно " << setprecision(12) << Adams(0, 0.25, h, i + 2) << endl
                     << "При этом погрешность равна " << setprecision(12) << abs(Adams(0, 0.25, h, i + 2) - exact_sol(x_0 + i * h)) << endl;
            }
            cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" << endl;
        }
        cout << "Давайте прогоним еще раз! Согласны? Введите значение ключа. Напоминаю:" << endl
